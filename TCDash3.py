...
class main(GridLayout):
    ...
    def __init__(self,**kwargs):
        ...
        #self.video = Video(source='http://172.20.10.4:8080/')
...
class TCDash(App):
    NetworkTable.setIPAddress("127.0.0.1")#for robot will be 10.2.17.2 aka ip of rio or NetworkTable.setClientMode()
    #NetworkTable.setDashboardMode() #may make things easier at comps    NetworkTable.initialize()
